...
instance Foldable Rose where
  fold (x :> xs) = foldr (mappend) x (map fold xs)
    --error "you have to implement fold"
...
fsum xs = unSum $ foldMap Sum xs
  --error "you have to implement fsum"
fproduct xs = unProduct $ foldMap Product xs
  --error "you have to implement fproduct"
